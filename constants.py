...
TRAIL_SIMILARITY_THRESHOLD = 0.8 # for triplet
TRAIL_WEAK_SIMILARITY_THRESHOLD = 0.7 # for triplet
TRAIL_LOOKAHEAD_SIMILARITY_THRESHOLD = 0.8 # for triplet
...
MULTI_NUM_AGENTS = 1
MULTI_AGENT_RANDOM_MOVEMENT_CHANCE = 0.3
MULTI_AGENT_STATE_SEARCH = 0
MULTI_AGENT_STATE_HOME = 1

TRAIL_LOOKAHEAD_MIN_INDEX = 1
TRAIL_LOOKAHEAD_MAX_INDEX = 15
TRAIL_K_NEAREST_NEIGHBORS = 6
TRAIL_TEMPORALITY_BEHIND_WINDOW_SIZE = 10
TRAIL_TEMPORALITY_AHEAD_WINDOW_SIZE = 30
TRAIL_SIMILARITY_INNER_BOUND_RATE = 0.25
TRAIL_EVAPORATION_COEFFICIENT_RATE = 0.0001
