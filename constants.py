...
PLACE_IMAGE_SIZE = PLACE_RESNET18_IMAGE_SIZE if PLACE_TOP_MODEL == PLACE_TOP_SIAMESE else PLACE_PLACENET_IMAGE_SIZE
PLACE_IMAGE_WIDTH = PLACE_RESNET18_IMAGE_WIDTH if PLACE_TOP_MODEL == PLACE_TOP_SIAMESE else PLACE_PLACENET_IMAGE_WIDTH
PLACE_IMAGE_HEIGHT = PLACE_RESNET18_IMAGE_HEIGHT if PLACE_TOP_MODEL == PLACE_TOP_SIAMESE else PLACE_PLACENET_IMAGE_HEIGHT
