...
TRAIL_GROUND_RADIUS_THRESHOLD = 300 # LOST ground-base
ACTION_LOOKAHEAD_PROB_THRESHOLD = 0.9
ACTION_LOOKAHEAD_LEN = 10
ACTION_LOOKAHEAD_ENABLED = True
SEQUENCE_VELOCITIES = [0.0, 0.3, 0.5, 0.8, 1.0, 1.5]
SEQUENCE_LENGTH = 5
TEMPORALITY_ENABLE = False
TEMPORALITY_LENGTH = 5
TEMPORALITY_OFFSET = 0
TEMPORALITY_NORM_SIGMA = 100
TEMPORALITY_FORWARD_GAIN = 2
TEMPORALITY_BACKWARD_GAIN = 1
...
MULTI_AGENT_PATH_STABILIZATION_RATE = 10 # every 5 episodes
...
TRAIL_EVAPORATION_COEFFICIENT_RATE = 0.1 # 0.1 per goal reaching # 0.00015 per action
